...
Los métodos *post-hoc* se aplican después de entrenar el modelo y pueden clasificarse según su alcance [@molnar2025]:
...
- **Métodos locales**: explican una predicción individual.
  - **Ceteris paribus / ICE**: muestran cómo cambia una predicción particular al modificar una variable.
