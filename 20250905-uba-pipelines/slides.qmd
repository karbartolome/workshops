---
title: "Del dato al modelo: piplines personalizados utilizando python"
...
Se cuenta con un dataset de `{python} df.shape[0]` transacciones (compras). Son `{python} df.shape[1]` variables generadas sintéticamente por lo que el foco está sobre cómo procesarl los datos y no sobre la performance del modelo [^1].
