...
@molnar2025 destaca algunos aspectos de las buenas explicaciones:

::: {style="font-size: 70%;"}

- Veracidad, generalidad y probabilidad

- Contraste, selectividad y dimensión social

::: {.fragment .highlight-red}
- Consistencia con las creencias previas
:::
